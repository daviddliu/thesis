...
pgm.add_node(daft.Node("alpha", r"$\alpha$", 2, 4, observed=True))
...
pgm.add_plate(daft.Plate([1.55, 2.60, 2, 1], label=r"$k = 1, \ldots, K, \ldots, (\infty)$",
        shift=-0.1, label_offset=[115, 0]))

pgm.add_plate(daft.Plate([0.4, 0.45, 3, 1.83], label=r"$n = 1, \ldots, N$",
        shift=-0.1, label_offset=[175, 0]))

pgm.add_plate(daft.Plate([2.55, 2.78, 0.85, 0.62], label=r"$m = 1, \ldots, M$",
        shift=-0.1, label_offset=[49, 20]))

pgm.add_plate(daft.Plate([0.62, 0.7, 1.75, 1], label=r"$m = 1, \ldots, M$",
